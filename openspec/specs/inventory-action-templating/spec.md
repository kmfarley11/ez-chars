# Capability: Inventory Action Templating

## Purpose

This capability enables users to create runtime actions interactively from their character's inventory items using a guided, multi-step dialog. It provides safe, reversible preparation of action data without prematurely mutating the character's sheet.
