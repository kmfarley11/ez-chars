...
This capability enables users to create runtime actions from eligible character-owned inventory, spells, Features, and Traits—or from a custom draft—through a searchable, guided multi-step dialog without prematurely mutating the character.
