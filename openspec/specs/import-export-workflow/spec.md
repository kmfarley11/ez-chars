# import-export-workflow Specification

## Purpose

Define the focused, validated dialog workflows for importing and exporting character backups without accidental local-data mutation.
