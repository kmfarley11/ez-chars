...
- **D&D 5e 2024**, using the explicitly adopted SRD 5.2.1 release; the project will recheck its provenance before public handoff, while any upgrade to a later SRD requires a separate owner decision rather than a silent latest-version switch;
