...
>
> This file is intentionally kept separate from the active MVP working set. For current implementation work, use [../../AGENTS.md](../../AGENTS.md), [../current-mvp.md](../current-mvp.md), and [../mvp-backlog.md](../mvp-backlog.md).
