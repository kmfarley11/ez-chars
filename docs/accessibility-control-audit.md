...
**Scope:** Current home-to-character-sheet flow on the phone-sized, coarse-pointer presentation
...
| Collapsible `GridContainer` headings                | Generated expand/collapse label                     | 36 px representative height; unmounted children correctly leave tab order                         | Corrected; collapsed-content keyboard test passes                                        | None                                                                      |
