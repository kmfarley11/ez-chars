...
- annotation/reference UI exists for surfaced fields, and the target direct field-editing interaction model plus field binding contract are documented in [docs/field-interaction-model.md](field-interaction-model.md) and [docs/field-binding-contract.md](field-binding-contract.md)
