...
- 5e sheet route now covers top-level info, quick reference, an ability-centered abilities/proficiencies runtime section, and a spells runtime section, but still only part of the schema
